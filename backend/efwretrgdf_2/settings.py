"""
Django settings for efwretrgdf_2 project.
...
ROOT_URLCONF = 'efwretrgdf_2.urls'
...
WSGI_APPLICATION = 'efwretrgdf_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "efwretrgdf_2 API",
    "DESCRIPTION": "API documentation for efwretrgdf_2 App",
    "VERSION": "v1",
}
